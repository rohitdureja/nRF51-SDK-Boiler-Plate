...
static __inline void nrf_gpiote_task_config(uint32_t channel_number, uint32_t pin_number, nrf_gpiote_polarity_t polarity, nrf_gpiote_outinit_t initial_value)
{
    ...
    if (initial_value == NRF_GPIOTE_INITIAL_VALUE_LOW)
    {
        ...
        ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1 << pin_number);
        
         
        ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[channel_number] = ((0x03UL)       << (0UL))     |
                                             (31UL                          << (8UL))     |
                                             ((0x02UL) << (16UL));                                    
    } 
    else 
    {
        ...
        ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1 << pin_number);
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->TASKS_OUT[channel_number] = 1;
    

    
 
    ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[channel_number] = ((0x03UL) << (0UL))     |
                                         ((uint32_t)pin_number    << (8UL))     |
                                         ((uint32_t)polarity      << (16UL)) |
                                         ((uint32_t)initial_value << (20UL));
...
{   
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[channel_number] = ((0x01UL) << (0UL))     |
                                         ((uint32_t)pin_number     << (8UL))     |
                                         ((uint32_t)polarity       << (16UL));
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->EVENTS_IN[channel_number] = 0; 
}
...
{   
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[channel_number] = ((0x00UL)   << (0UL)) |
                                         (31UL                          << (8UL)) |
                                         ((0x03UL) << (16UL));
}
...
static void gpiote_init(void) 
{
	...
	nrf_gpiote_task_config(0, 18, NRF_GPIOTE_POLARITY_TOGGLE, 													NRF_GPIOTE_INITIAL_VALUE_LOW);
...
static void ppi_init(void)
{
	...
	((NRF_PPI_Type *) 0x4001F000UL)->CH[0].EEP = (uint32_t)&((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[0];
	((NRF_PPI_Type *) 0x4001F000UL)->CH[0].TEP = (uint32_t)&((NRF_GPIOTE_Type *) 0x40006000UL)->TASKS_OUT[0];

	
	((NRF_PPI_Type *) 0x4001F000UL)->CHEN = ((1UL) << (0UL));
}
...
static void timer0_init(void)
{
	...
	((NRF_TIMER_Type *) 0x40008000UL)->CC[0]     = 200 * 1000UL; 
