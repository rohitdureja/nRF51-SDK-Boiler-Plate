...
static void gpio_init(void)
{
	...
	nrf_gpiote_event_config(0, 16, (0x03UL));
	((NRF_GPIOTE_Type *) 0x40006000UL)->INTENSET = (1UL) << (0UL);
}

void GPIOTE_IRQHandler(void)
{
	
	if ((((NRF_GPIOTE_Type *) 0x40006000UL)->EVENTS_IN[0] == 1) &&
		(((NRF_GPIOTE_Type *) 0x40006000UL)->INTENSET & (0x1UL << (0UL))))
	{
		((NRF_GPIOTE_Type *) 0x40006000UL)->EVENTS_IN[0] = 0;
