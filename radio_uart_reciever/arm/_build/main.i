...
int main(void)
{
  ...
  while(1)
  {
    ...
    while(((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_READY == 0U)
    {
    }
    ((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_END = 0;
    
    ((NRF_RADIO_Type *) 0x40001000UL)->TASKS_START = 1;
    
    while(((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_END == 0)
    {
    }
		nrf_gpio_pin_toggle(18);
    
    if (((NRF_RADIO_Type *) 0x40001000UL)->CRCSTATUS == 1)
    {
